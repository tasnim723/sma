    ...
    <GoogleOAuthProvider clientId={GOOGLE_CLIENT_ID}>
      <div className="min-h-screen w-full flex items-center justify-center relative bg-[#f1f5f9] font-sans overflow-hidden">
        ...
        <motion.div 
          ...
          className="w-full max-w-[420px] relative z-10 flex flex-col items-center px-4"
        >
          {/* Static Corner Accents with Subtle Breathing Effect */}
          <div className="absolute inset-x-4 inset-y-0 pointer-events-none z-20">
            <motion.div 
              className="absolute top-[-1px] left-[-1px] w-[130px] h-[130px] rounded-tl-[32px] border-t-[3px] border-l-[3px] border-[#e63946]/90" 
              animate={{ filter: [
            ...
            />
            <motion.div 
              className="absolute bottom-[-1px] right-[-1px] w-[130px] h-[130px] rounded-br-[32px] border-b-[3px] border-r-[3px] border-[#00BCD4]/90" 
              animate={{ filter: [
          ...
          {/* Card Container */}
          <div 
            className="w-full bg-white/10 backdrop-blur-3xl rounded-[32px] px-8 sm:px-10 pt-10 pb-6 relative overflow-hidden"
            style={{
          ...
          >
            ...
            <div className="flex flex-col items-center mb-6 w-full relative">
              <div className="flex flex-col items-center justify-center text-center mt-0">
                 ...
                 <div className="flex flex-col mb-4">
                   <div className="flex">
                     <div className="w-3.5 h-3.5 bg-[#ff0000]" />
                     <div className="w-3.5 h-3.5" />
                   </div>
                   <div className="flex">
                     <div className="w-3.5 h-3.5" />
                     <div className="w-3.5 h-3.5 bg-[#00BCD4]" />
                   </div>
                 </div>
                
                <h1 className="text-[32px] font-[900] text-[#0f172a] tracking-[0.14em] mr-[-0.14em] leading-none mb-2 font-sans">
                  NETINFO
                </h1>
                <p className="text-[9.5px] font-[800] text-gray-500 tracking-[0.22em] mr-[-0.22em] uppercase">
            ...
            <div className="text-center mb-5">
              <h2 className="text-[19px] font-[800] text-[#1e293b] mb-1">Connexion</h2>
              <p className="text-[12.5px] font-[600] text-gray-500">Accédez à votre espace SMA</p>
            </div>
              ...
              {mounted && (
                ...
                >
                  {googleLoading ? (
                    ...
                    <div
                      className="w-full rounded-[18px] overflow-hidden border-[1.5px] border-gray-200 hover:border-[#00BCD4]/50 transition-all duration-200 bg-white/80 hover:bg-white shadow-sm hover:shadow-md"
            ...
            <form onSubmit={handleLogin} className="w-full space-y-3">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative flex items-center group">
                  ...
                  <input
                    ...
                    className="w-full pl-[42px] pr-4 py-[13px] rounded-[18px] border-[1.5px] border-white bg-[#f1f5f9]/80 focus:bg-white focus:outline-none focus:ring-[3px] focus:ring-[#00BCD4]/20 focus:border-[#00BCD4]/50 text-[14px] text-gray-800 placeholder:text-gray-400 font-[600] transition-all shadow-[inset_0_2px_4px_rgba(0,0,0,0.02)]"
                    required
                  />
                </div>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative flex items-center group">
                  ...
                  <input
                    ...
                    className="w-full pl-[42px] pr-12 py-[13px] rounded-[18px] border-[1.5px] border-white bg-[#f1f5f9]/80 focus:bg-white focus:outline-none focus:ring-[3px] focus:ring-[#00BCD4]/20 focus:border-[#00BCD4]/50 text-[14px] text-gray-800 placeholder:text-gray-400 font-[600] transition-all shadow-[inset_0_2px_4px_rgba(0,0,0,0.02)] tracking-widest"
                    required
                  />
                  <button
                    type="button"
              ...
              <div className="pt-6 relative w-full flex justify-center">
                {/* Outer glow for button */}
                <div className="absolute inset-x-8 top-8 bottom-0 bg-[#00BCD4] opacity-50 blur-xl rounded-full" />
                <button
                  type="submit"
                  className="w-full max-w-[280px] relative bg-gradient-to-r from-[#00BCD4] to-[#019ab3] hover:from-[#00c5df] hover:to-[#01a7c2] active:scale-[0.98] text-white py-[15px] rounded-[20px] font-[800] text-[16px] transition-all duration-200 shadow-[0_6px_20px_rgba(0,188,212,0.3)] tracking-wide"
                >
                  Se connecter
                </button>
              </div>
            ...
            {/* Footer */}
            <div className="mt-10 pt-5 border-t border-gray-200/60 text-center">
